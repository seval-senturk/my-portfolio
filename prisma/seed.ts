...
async function seedAboutHome() {
  ...
  await prisma.aboutHomeConfig.upsert({
    ...
    update: {
      ...
      secondaryCtaVisible: content.secondaryCta.visible,
      profileImageAlt: content.profile.imageAlt,
      profileInitials: content.profile.initials,
      profileVisible: content.profile.visible,
    },
    create: {
      locale: LOCALE,
      visible: content.section.visible,
...
async function seedProjects() {
  await prisma.projectsPageConfig.upsert({
    ...
    update: {
      ...
      titleAccent: projectsContent.hero.titleAccent ?? null,
      ...
      homeSectionDescription: projectsContent.home.description ?? null,
  ...
  for (const [index, filter] of projectsContent.filters.entries()) {
    await prisma.projectPageFilter.upsert({
      where: { locale_slug: { locale: LOCALE, slug: filter.slug } },
      update: {
        label: filter.label,
  ...
  for (const [index, entry] of (
    ...
    await prisma.project.upsert({
      ...
      update: {
        ...
        coverImageAlt: entry.coverImageAlt ?? null,
...
async function seedContact() {
  ...
  await prisma.contactPageConfig.upsert({
    ...
    update: {
      ...
      infoLabelsConfig: toJson(contactContent.infoLabels),
      socialLinksConfig: toJson(contactContent.socialLinks),
    },
    create: {
      locale: LOCALE,
      sectionVisible: contactContent.section.visible,
