...
export const AuditActions = {
  ...
  PROJECTS_PAGE_CONFIG_UPDATED: "projectsPage.config.updated",
  PROJECT_FILTER_SAVED: "projectsPage.filter.saved",
  PROJECT_FILTER_DELETED: "projectsPage.filter.deleted",
  PROJECTS_REORDERED: "projects.reordered",
  PROJECT_FILTERS_REORDERED: "projectsPage.filters.reordered",
  ...
  TESTIMONIALS_CONFIG_UPDATED: "testimonials.config.updated",
  TESTIMONIAL_CREATED: "testimonial.created",
  TESTIMONIAL_UPDATED: "testimonial.updated",
  TESTIMONIAL_DELETED: "testimonial.deleted",
  TESTIMONIALS_REORDERED: "testimonials.reordered",
  BLOG_HOME_CONFIG_UPDATED: "blogHome.config.updated",
  BLOG_HOME_CURATED_ADDED: "blogHome.curated.added",
  BLOG_HOME_CURATED_REMOVED: "blogHome.curated.removed",
  BLOG_HOME_CURATED_REORDERED: "blogHome.curated.reordered",
  CONTACT_CONFIG_UPDATED: "contact.config.updated",
